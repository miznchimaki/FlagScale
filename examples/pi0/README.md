...
For example, there is a dataset of 2 timesteps: [demo_0913_n2](https://gitee.com/hchnr/flag-scale/tree/robotics_dataset/demo_0913_n2/wds-1).
...
- wds-1: Data in webdataset format (DP=1), generated by tools/datasets/vla/convert.py
