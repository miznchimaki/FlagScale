...
## Install Deps
Install megatron-energon(Version: 5.2.1.dev313+gab4022610) via source code.
Other versions support by `pip` like 5.2.0 and 6.0.0 don't work(no versions between 5.2.0 and 6.0.0).

```sh
pip install bitstring filetype ebmlite sortedcontainers

git clone https://github.com/NVIDIA/Megatron-Energon.git
cd Megatron-Energon
git checkout ab40226100830f41de38d1f1204d7848b54b1f3e
pip install -e .
```
