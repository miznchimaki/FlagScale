...
from flagscale.models.pi0_old.normalize import Normalize, Unnormalize
from flagscale.models.pi0_old.paligemma_with_expert import (
    PaliGemmaWithExpertConfig,
    PaliGemmaWithExpertModel,
)
from flagscale.models.pi0_old.types import ACTION, OBS_STATE, FeatureType
...
class PI0PolicyConfig(PretrainedConfig):
    ...
    def action_feature(self):
        for ft_name, ft in self.output_features.items():
            if ft["type"] == FeatureType.ACTION and ft_name == ACTION:
                return ft
        return None


class PI0Policy(PreTrainedModel):
    ...
    def from_pretrained(cls, model_path, tokenizer_path, stat_path, config):
        ...
        policy = PI0Policy(model_path, tokenizer_path, stat, config)
        return policy
